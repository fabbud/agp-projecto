...
import bannerImage from '../../assets/images/AssociacaoMundial/Associação_Mundial.jpg';
    ...
    <div className="AssociacaoMundial">
      ...
      <div className="world-association">
        ...
        <p className="world-text">
          A WAGGGS – World Association of Girl Guides and Girl Scouts – é a maior organização mundial
          de raparigas e jovens mulheres voluntárias, da qual a AGP é membro. Atualmente, integra
          cerca de 10 milhões de jovens espalhadas por 150 países, estando dividida em cinco
          Regiões: <a href="https://www.wagggs.org/en/our-world/africa/" target="_blank" rel="noopener noreferrer"> África</a>
          ,&nbsp;
      ...
      <div>
        <div>
          <div>Centros Mundiais</div>
          <div>
            Os cinco Centros Mundiais da WAGGGS oferecem a oportunidade de uma aventura internacional. Aqui, as Guias podem encontrar-se, experienciar um mundo de possibilidades em atividades e conhecer outras Guias de outros países, embarcando numa jornada de descoberta pessoal através da dimensão internacional.
          </div>
          <ul>
        ...
        <div>
          <img src={worldMap} alt="World Association Map" />
        </div>
      </div>
      <div>
        <div>
          <div>
            <img src={worldThought} alt="World Thought" />
          </div>
          <div>
            <div>Dia Mundial do Pensamento</div>
            <div>
              <p>
                “O 22 de fevereiro é um dia de festa, em que fazemos em pensamento a volta ao mundo.”
                Baden-Powell
              </p>
              <p>
                O dia 22 de fevereiro é um dia muito especial para todas as Guias do mundo. Intitulado
              ...
              <p>Esta data, comemorada desde 1926 é ainda um momento para alertar para temas da atualidade, especialmente os que afetam as raparigas e jovens mulheres e para angariar fundos de apoio à ação da Associação Mundial das Guias (WAGGGS) em todo o mundo, em particular para projetos de capacitação das raparigas.</p>
              <p>
                É uma oportunidade para cada Guia celebrar a data e ser uma em 10 milhões, ser inspirada pela história e o impacto do Guidismo, conectar-se com as Guias pelo mundo, criar ações e despertar os outros para questões importantes e fazer a diferença, angariando fundos para projetos através do
        ...
        <div>
          <div>
            <img src={worldPenny} alt="World Penny" />
          </div>
          <div>
            <div>Tostão Mundial</div>
            <div>
              ...
              <p>
                ...
                Com o mote "A penny for your thoughts" (Um tostão pelos teus pensamentos) foi assim
                criado o Fundo do Dia do Pensamento, também designado por
